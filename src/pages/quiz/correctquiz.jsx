...
<div className='  m-auto rounded-lg p-2 bg-blue-500'>
<h2 className='   text-center  text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-yellow-400 animate-gradient'>votre réponse </h2>
</div>
      <div>
      ...
      <button className=' float-right' onClick={()=>{Navigate("/quiz")}} ><Butonstylev2  text=" next Quiz" /> </button>
